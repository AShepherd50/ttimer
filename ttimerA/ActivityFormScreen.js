...
import {View, TextInput, Text, Button, StyleSheet, Dimensions, Switch} from 'react-native'
    ...
    if(!isBreak) {
        return (
            <View>
                ...
                <Button title="Done" style={styles.button} onPress={() => {
                    if(minute > 60 || sec > 60){
                    ...
                    navigation.navigate({
                        ...
                        params: {title: title, hour: hour, minute: minute, sec: sec, repeat: repeat, isBreak: isBreak }
                    });
                }}
                />
            </View>
        ...
        return (
            <View>
                ...
                <Button title="Done" style={styles.button} onPress={() => {
                    ...
                    navigation.navigate({
                        name: 'ProfileFormScreen',
                        params: {title: title, hour: hour, minute: minute, sec: sec, repeat: repeat, isBreak: isBreak, breakHr: breakHr, breakMin: breakMin, breakSec: breakSec}
                    });
                }}
                />
            </View>
